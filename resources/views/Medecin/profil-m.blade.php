                ...
                <div class="row">
                    <div class="col-xl-4 col-12">
                        <div class="box">
                            <div class="box-body box-profile">
                                <div class="row">
                                    <div class="col-12">
                                        <div>
                                            <p>Email :<span class="text-gray ps-10">{{ Auth::user()->email }}</span>
                                            </p>
                                            <p>Phone :<span class="text-gray ps-10">{{ Auth::user()->telephone }}</span>
                                            </p>
                                            <p>Address :<span class="text-gray ps-10">{{ Auth::user()->adresse }}</span>
                                            </p>
                                            <p>Maladie :
                                        ...
                                        <div>
                                            <div class="map-box">
                                                <iframe
                                                    ...
                                                    class="w-p100" height="175" style="border:0" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('dashboard/images/avatar/doctor.png') }}"
                            ...
                            <div class="box-body wed-up position-relative">
                                <div class="d-md-flex align-items-center">
                                    <div class=" me-20 text-center text-md-start">
                                        <img src="{{ asset('dashboard/images/avatar/1--.png') }}"
                                            class="bg-success-light rounded10" alt="" style="width: 120px;" />
                                        <div class="text-center my-10">

                                        </div>
                                    </div>
                                    <div class="mt-40">
                                        <h4 class="fw-600 mb-5" style="margin-top: 20px;">{{ Auth::user()->nom }}
                                            {{ Auth::user()->prenom }}
                                        </h4>
