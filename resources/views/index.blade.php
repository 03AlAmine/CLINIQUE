                                ...
                                <fieldset id="third">
                                    <div class="row page">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-12">
                                            <div class="form-group">
                                                <i class="icon-news form-group-info"></i>
                                                <label for="details">Avez-vous déjà reçu des soins chez clinique DieAmnie?</label>
          ...
          <option value="choisir" disabled selected = "selected">Choisir</option>
            ...
            <option value="Non">
              Non, c'est mon premier rendez-vous
                                        ...
                                        <div class="col-sm-4 col-md-12 col-lg-12 id_DieAmnie">
                                            <div class="form-group form-group-date">
                                                <i class="icon-user form-group-icon"></i>
                                                <input type="text" class="form-control DieAmnieID" placeholder="ID DieAmnie" id="DieAmnie-id" name="DieAmnieID">
                                            </div>
                                        </div>
                                        <!-- /.col-lg-4 -->
                                        <div class="col-12 field btns">
